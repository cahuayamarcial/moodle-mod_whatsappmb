...
/**
 * Spanish language strings for the mod_whatsappmb plugin.
 *
...
$string['invalidnumber'] = 'Por favor, ingrese un número de teléfono válido en formato internacional (por ejemplo, +1234567890).';
$string['invalidgrouplink'] = 'Por favor, ingrese un enlace válido de grupo de WhatsApp (por ejemplo, https://chat.whatsapp.com/XXXXXXX).';
...
$string['privacy:metadata:none'] = 'El plugin WhatsApp by Marbot no almacena información personal.';
